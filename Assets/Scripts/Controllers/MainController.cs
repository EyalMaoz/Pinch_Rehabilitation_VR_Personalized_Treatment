...
// MainController is one of the main class for our application.
// It is attached to "MainMenu" that passes between each scene. 
// It controls the screen managment and the current data about the patient and the therapist.
// During a game there is only one instace of this class but due to some other needs we didnt made it 
// singleton and created the AbstractController instead.
// This class contains static and dynamic functions and data as needed.
...
public class MainController : MonoBehaviour
{
    ...
    public void SetDefaultPlanIfNeeded()
    {
        try
        {
            ...
            {
                CurrentPatient.CurrentTreatment = new TreatmentPlan(DefaultPlan);
            }
        }
        catch (Exception e)
        {
