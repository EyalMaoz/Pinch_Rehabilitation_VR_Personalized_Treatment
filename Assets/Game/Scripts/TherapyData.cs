...
{
    // This class is basically our algorithm implemntation and our data type for the treatment.
    public class TherapyData
    {
        ...
        {
            None, Pad2, Pad3, Tip2, Tip3
        }

        public const int _DifficultyMax = 10;
        public const int _DifficultyRange = 10;
        public const int _DifficultyMin = 1;
        // we get this from user, 5 is just a default that never used:
        public static int dpT2 = 5;
        public static int dpP2 = 5;
        public static int dpT3 = 5;
        public static int dpP3 = 5;
        ...
        public static class Algorithm
        {
            ...
            private static Challenge CreateNewChallenge(Challenge original, int PT, int ST)
            {
                Challenge newChal;
                if (original.Source == null)
            ...
            private static List<Challenge> SinglePointCrossover(Challenge c1, Challenge c2)
            {
            ...
            private static List<Challenge> SelectChromForNextLevel(List<Challenge> chromosomePool)
            {
